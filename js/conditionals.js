 ...
 */
// let promptColor = prompt('What is your favorite color?')
//
// switch (promptColor) {
//     case 'red':
//         alert("The color blue is the color of the sky.");
//         break;
//     case 'blue':
//         alert("The color blue is the color of the sky.");
//         break;
//     case 'green':
//         alert("The color green is the color of grass.");
//         break;
//     default:
//         alert("The color " + randomColor + " is not a primary color.");
//         break;
// }
...
let changedNumber = parseInt(givenNumber);
  ...
  if(isNaN(changedNumber)){
      ...
      (changedNumber % 2 ===  0) ? alert("The number is even.") : alert("The number is odd.");
      alert(changedNumber + 100);
      (changedNumber > 0) ? alert("Number is positive.") : alert("Number is a negative.");
  }
